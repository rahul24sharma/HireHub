...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React13.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React13.useRef(open);
  const {
    subitems,
    contextValue: compoundComponentContextValue
  } = useCompoundParent();
  ...
  const reducerActionContext = React13.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
var TransitionContext = React16.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React17.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React18.useState(true);
  const hasPendingExitTransition = React18.useRef(false);
  const registeredTransitions = React18.useRef(0);
  const [hasTransition, setHasTransition] = React18.useState(false);
  const previousRequestEnter = React18.useRef(requestEnter);
  React18.useEffect(() => {
  ...
  const handleExited = React18.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React18.useCallback(() => {
...
var PopupContext = React19.createContext(null);
if (true) {
...
var Popup = React20.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React20.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React21.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React22.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React23.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
function useMenuItem(params) {
  ...
  const itemMetadata = React24.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React24.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useMenuItemContextStabilizer(id) {
  ...
  const localGetItemState = React25.useCallback((itemValue) => {
    if (itemValue !== itemId) {
  ...
  const localContextValue = React25.useMemo(() => ({
    dispatch,
...
var InnerMenuItem = React26.memo(React26.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
...
var MenuItem2 = React26.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
var Modal = React28.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React30.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React30.useMemo(() => {
    return {
      min: min2,
      max: max2,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React30.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React31.forwardRef(function NumberInput2(props, forwardedRef) {
...
var InnerOption = React33.memo(React33.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React33.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
var Select = React34.forwardRef(function Select2(props, forwardedRef) {
  ...
  const handleButtonRefChange = React34.useCallback((element) => {
...
function useSlider(parameters) {
  ...
  const [focusedThumbIndex, setFocusedThumbIndex] = React35.useState(-1);
...
var Slider = React36.forwardRef(function Slider2(props, forwardedRef) {
...
var Snackbar = React38.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React40.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React41.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React42.forwardRef(function TablePagination2(props, forwardedRef) {
...
function useTabs(parameters) {
  ...
  const onSelected = React43.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React43.useRef(() => void 0);
  const getTabPanelId = React43.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React43.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React43.useCallback((lookupFunction) => {
...
var TabsContext = React44.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React44.useContext(TabsContext);
  if (context == null) {
...
var Tabs = React46.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React47.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
function useTabsList(parameters) {
  ...
  const contextValue = React49.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
var Tab = React53.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
...
function CssAnimation(props) {
  ...
  const hasExited = React54.useRef(true);
  React54.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React54.useCallback((event) => {
...
var CssTransition = React55.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React55.useState(false);
  React55.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React55.useCallback((event) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6PDOWS5J.js.map
